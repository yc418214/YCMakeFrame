...
#ifndef YCMakeFrameMacros_h
#define YCMakeFrameMacros_h

static inline id _YCFrameBoxValue(const char *type, ...);

#define YCFrameBoxValue(value)      _YCFrameBoxValue(@encode(__typeof__((value))), (value))
